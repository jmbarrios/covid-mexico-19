...
class IdentityField(serializers.HyperlinkedIdentityField):
    def get_url(self, obj, view_name, request, format):
        kwargs = {'entidad': obj.entidad.clave}
        return self.reverse(
            view_name,
            kwargs=kwargs,
            request=request,
...
class EntidadPoblacionListSerializer(serializers.ModelSerializer):
    url = IdentityField(view_name='entidadpoblacion-detail')
...
class EntidadPoblacionSerializer(EntidadPoblacionListSerializer):
