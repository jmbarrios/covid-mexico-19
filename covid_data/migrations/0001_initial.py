    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.IntegerField(choices=[(1, 'HOMBRE'), (2, 'MUJER')], help_text='Identifica al sexo del paciente.', null=True)),
                ...
                ('intubado', models.BooleanField(help_text='Identifica si el paciente requirió de intubación.', null=True)),
                ('neumonia', models.BooleanField(help_text='Identifica si al paciente se le diagnosticó con neumonía.', null=True)),
                ('edad', models.IntegerField(help_text='Identifica la edad del paciente.')),
                ('nacionalidad', models.CharField(choices=[('MX', 'MX'), ('EX', 'EX')], help_text='Identifica si el paciente es mexicano o extranjero.', max_length=2, null=True)),
                ('embarazo', models.BooleanField(help_text='Identifica si la paciente está embarazada.', null=True)),
                ('habla_lengua_indigena', models.BooleanField(help_text='Identifica si el paciente habla lengua índigena.', null=True)),
                ('diabetes', models.BooleanField(help_text='Identifica si el paciente tiene un diagnóstico de diabetes.', null=True)),
                ('epoc', models.BooleanField(help_text='Identifica si el paciente tiene un diagnóstico de EPOC.', null=True)),
                ('asma', models.BooleanField(help_text='Identifica si el paciente tiene un diagnóstico de asma.', null=True)),
                ('inmusupr', models.BooleanField(help_text='Identifica si el paciente presenta inmunosupresión.', null=True)),
                ('hipertension', models.BooleanField(help_text='Identifica si el paciente tiene un diagnóstico de hipertensión.', null=True)),
                ('otras_com', models.BooleanField(help_text='Identifica si el paciente tiene diagnóstico de otras enfermedades.', null=True)),
                ('cardiovascular', models.BooleanField(help_text='Identifica si el paciente tiene un diagnóstico de enfermedades cardiovasculares.', null=True)),
                ('obesidad', models.BooleanField(help_text='Identifica si el paciente tiene diagnóstico de obesidad.', null=True)),
                ('renal_cronica', models.BooleanField(help_text='Identifica si el paciente tiene diagnóstico de insuficiencia renal crónica.', null=True)),
                ('tabaquismo', models.BooleanField(help_text='Identifica si el paciente tiene hábito de tabaquismo.', null=True)),
                ('otro_caso', models.BooleanField(help_text='Identifica si el paciente tuvo contacto con algún otro caso diagnósticado con SARS CoV-2', null=True)),
                ('migrante', models.BooleanField(help_text='Identifica si el paciente es una persona migrante.', null=True)),
                ('uci', models.BooleanField(help_text='Identifica si el paciente requirió ingresar a una Unidad de Cuidados Intensivos.', null=True)),
